...
from HK.settings import host,user1,password1,database,table,today_url,proxies
...
class ThinkHkQuchongMiddleware(object):
    def __init__(self):
        # print('数据库链接')
...
class HkSpiderMiddleware(object):
...
class HkDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
